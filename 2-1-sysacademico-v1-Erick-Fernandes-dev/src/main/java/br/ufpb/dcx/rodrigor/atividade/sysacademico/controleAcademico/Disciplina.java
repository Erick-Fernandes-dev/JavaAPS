...
public class Disciplina {
    ...
    public boolean alunoMatriculado(Aluno aluno, String matricula) {

        boolean alunoMatriculadoCurso = aluno.equals(this.curso.getAluno(matricula));

        if (alunoMatriculadoCurso) {
            return true;
        }
